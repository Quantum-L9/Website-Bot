...
4. LLM intelligence layer: `@l9/llm-router` in `packages/llm-router`, consumed via `src/services/llm.ts`.
...
The `@l9/llm-router` module provides intelligent model selection for all AI-powered operations:
