...
const outPath = resolveUnder(
  ROOT,
  process.argv[4] ?? "tests/golden/safehaven/oracle-coverage.json",
);
...
const TABLE = {
  ...
  "legacy_authority.redesign_schema_llm_calls": {
    anchor: "REDESIGN_SCHEMA_LLM_AUTHORITY_VIOLATION",
  ...
  "llm_audit.required_policy.CONTENT_VALIDATION": {
    anchor: "UNEXPECTED_SEARCH_ROUTING",
    evidence: "llm_audit.operations[]",
    nc: "NC-18",
  },
  "llm_audit.required_policy.VISUAL_QA": {
    anchor: "VISUAL_QA_ROUTER_AUDIT_MISSING",
    evidence: "llm_audit.operations.VISUAL_QA",
    nc: null,
    note: "VISUAL_QA calls must suppress search; missing router audit fails",
  },
  "llm_audit.unsupported_capability_combination_count": {
    anchor: "UNSUPPORTED_LLM_CAPABILITY_COMBINATION",
  ...
  "visual_oracle.trials_per_pair": {
    anchor: "VISUAL_TRIAL_INCOMPLETE",
    evidence: "visual.pairs[].trials",
    nc: null,
  },
  "visual_oracle.pass.minimum_pair_majority_wins": {
    anchor: "VISUAL_IMPROVEMENT_INSUFFICIENT",
    evidence: "normalized_preference",
    nc: "NC-20",
  },
  "visual_oracle.pass.maximum_pair_majority_losses": {
    anchor: "VISUAL_REGRESSION_TOO_BROAD",
    evidence: "normalized_preference",
    nc: null,
  },
  "visual_oracle.pass.minimum_candidate_votes": {
    anchor: "VISUAL_VOTE_CONFIDENCE_INSUFFICIENT",
    evidence: "normalized_preference",
    nc: null,
  },
  "visual_oracle.pass.wilson_lower_bound_must_exceed": {
    anchor: "VISUAL_CONFIDENCE_INTERVAL_INCONCLUSIVE",
    evidence: "normalized_preference",
    nc: null,
  },
  "visual_oracle.pass.critical_pairs_may_not_lose": {
    anchor: "CRITICAL_VISUAL_PAIR_REGRESSED",
    evidence: "visual.pairs[]",
    nc: "NC-21",
    note: "critical pair set read dynamically from oracle.json; missing config fails closed",
  },
  "visual_oracle.pass.critical_dimensions_may_not_regress": {
    anchor: "CRITICAL_VISUAL_DIMENSION_REGRESSED",
    evidence: "normalized_candidate_delta",
    nc: "NC-22",
    note: "dimension list read dynamically from oracle.json; missing config fails closed",
  },
  "visual_oracle.pass.minimum_weighted_mean_delta": {
    anchor: "VISUAL_WEIGHTED_MEAN_DELTA_INSUFFICIENT",
    evidence: "normalized_candidate_delta + oracle dimension weights",
    nc: null,
    note: "weighted mean delta computed from oracle.json dimension weights; threshold read dynamically",
  },
  "visual_oracle.dimensions": {
    anchor: "VISUAL_DIMENSION_MISSING",
    evidence: "oracle.visual_oracle.dimensions",
    nc: null,
    note: "weights consumed dynamically; weight sum validated == 1.0; every configured dimension required in every trial",
  },
  "visual_oracle.reveal_candidate_identity_to_judge": {
    anchor: "VISUAL_JUDGE_NOT_BLIND",
    evidence: "visual.trials[].blind",
    nc: null,
  },
  "visual_oracle.inconclusive.missing_trial": {
    anchor: "VISUAL_ORACLE_MISSING_TRIAL",
    evidence: "visual.pairs[].trials",
    nc: null,
  },
  "visual_oracle.inconclusive.judge_disagreement_without_majority": {
    anchor: "VISUAL_PAIR_NO_MAJORITY",
    evidence: "normalized_preference",
    nc: null,
  },
  "visual_oracle.inconclusive.wilson_interval_crosses_required_boundary": {
    anchor: "VISUAL_WILSON_INTERVAL_INCONCLUSIVE",
    evidence: "wilson bounds",
    nc: null,
  },

  // ---- final verdict --------------------------------------------------------
  "final_verdict.pass_requires.all_hard_gates_pass": {
    anchor: "hard_gate_failures",
    evidence: "failures[]",
    nc: "NC-25",
  },
  "final_verdict.pass_requires.visual_oracle_pass": {
    anchor: "VISUAL_IMPROVEMENT_INSUFFICIENT",
    evidence: "visual aggregate",
    nc: null,
  },
  ...
  "final_verdict.pass_requires.no_inconclusive_blocking_dimension": {
    anchor: "GOLDEN_ORACLE_BLOCKING_INCONCLUSIVE",
    evidence: "visual inconclusive rules",
    nc: null,
  },
};
...
const report = {
  ...
  properties: entries,
  verdict:
    unenforced.length === 0 && staleCitations.length === 0
