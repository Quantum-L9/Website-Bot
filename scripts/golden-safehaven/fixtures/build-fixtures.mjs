...
writeJson(path.join(ASSETS, "intelligence", "website-build-blueprint.json"), {
  ...
  payload: {
    ...
    provenance: {
      ...
      baseline_digest: sha256Of("baseline"),
      client_vision_digest: sha256Of("client-vision"),
      design_reference_intelligence_digest: sha256Of("design-reference-intelligence"),
      pattern_portfolio_digest: sha256Of("patterns"),
    },
    design_direction: {
      principles: [],
      desired_attributes: [],
