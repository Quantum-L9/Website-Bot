...
export class ContextResolver {
  ...
  ): Promise<{ targetEnvironment: string; environmentType: string }> {
  ...
  private async resolveRequiredServices(_config: ValidationConfig): Promise<string[]> {
    const services = [];
  ...
  private async resolveTargetEndpoints(_config: ValidationConfig): Promise<string[]> {
    const endpoints = [];
  ...
  private async resolveRequiredCredentials(_config: ValidationConfig): Promise<string[]> {
    const credentials = [];
