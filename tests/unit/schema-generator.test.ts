...
const FAQ_JSON =
  '[{"question":"How long does a roof last?","answer":"20-30 years."},{"question":"Do you offer inspections?","answer":"Yes, free."}]';
...
void test("site URL is normalized to https and phone flows into schemas", async () => {
  ...
  const crumbs = ctx.generatedSchemas.get("BreadcrumbList") as {
