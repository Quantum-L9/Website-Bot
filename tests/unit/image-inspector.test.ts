...
import { detectMimeType, inspectImage, ImageInspectError } from '../../src/services/images/ImageInspector.js';
...
void test('detects SVG from markup and extracts declared size', () => {
  const svg = Buffer.from('<svg xmlns="http://www.w3.org/2000/svg" width="120" height="48"></svg>', 'utf8');
