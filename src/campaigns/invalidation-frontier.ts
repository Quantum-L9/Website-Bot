...
const BLUEPRINT_STAGES: readonly PipelineStage[] = ["website-blueprint", "seo-content-blueprint"];

const CONTENT_STAGES: readonly PipelineStage[] = ["page-content-contract", "structured-content"];
 ...
 */
export function assertFrontier(
  layer: MutationLayer,
  attempted: AttemptedStage[],
): AttemptedStage[] {
