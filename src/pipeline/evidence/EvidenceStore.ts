...
export interface EvidenceStore {
  ...
  transitionStageSucceeded(stage: string): Promise<EvidenceIndex>;
  transitionStageFailed(stage: string, failure: EvidenceRecord): Promise<EvidenceIndex>;
  transitionRunConverged(): Promise<EvidenceIndex>;
