...
export function validatePublicationEvidence(value: unknown): asserts value is PublicationEvidence {
  ...
  if (evidence.schema !== 'website-bot.publication-evidence/v1' || evidence.status !== 'passed' || !evidence.publicationId || !evidence.buildId || !evidence.clientId || !evidence.buildProofId) {
