...
export interface StageRunResult { externalId?: string; }
    ...
    try {
      ...
      for (const stage of this.stages) {
        ...
        try {
          ...
          await this.ensureCheckpoint(ctx, stage, attempt, startedAt, inputEvidence, outputEvidence, stageResult?.externalId);
