> **Archived 2026-08-14.** Living decision: [`docs/adr/ADR-0017-generation-claims-require-llm-credentials.md`](../adr/ADR-0017-generation-claims-require-llm-credentials.md) (model routing remains [ADR-0003](../adr/ADR-0003-llm-capability-routing.md)). This file is historical source, not the contract.
